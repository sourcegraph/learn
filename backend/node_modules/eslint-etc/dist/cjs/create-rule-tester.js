...
function createRuleTester({ filename = path_1.resolve("./tests/file.ts"), parser = path_1.resolve("./node_modules/@typescript-eslint/parser"), project = path_1.resolve("./tests/tsconfig.json"), } = {}) {
