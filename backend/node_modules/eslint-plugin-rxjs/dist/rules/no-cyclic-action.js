...
const rule = utils_1.ruleCreator({
    ...
    create: (context, unused) => {
        ...
        const { getType, typeChecker } = eslint_etc_1.getTypeServices(context);
        function checkNode(pipeCallExpression) {
            const operatorCallExpression = pipeCallExpression.arguments.find((arg) => eslint_etc_1.isCallExpression(arg) &&
