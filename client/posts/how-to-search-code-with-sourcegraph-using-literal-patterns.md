...
<SourcegraphInteractiveSearch initialQuery='list_head' initialSearchURL={initialSearchURL} initialPatternType='literal' />
...
<SourcegraphInteractiveSearch initialQuery='list_add_tail' initialSearchURL={initialSearchURL} initialPatternType='literal' />
...
<SourcegraphInteractiveSearch initialQuery='React caught an error thrown' initialSearchURL={initialSearchURL} initialPatternType='literal' />
...
<SourcegraphInteractiveSearch initialQuery='const counter' initialSearchURL={initialSearchURL} initialPatternType='literal' />
...
<SourcegraphInteractiveSearch initialQuery='struct list_head' initialSearchURL={initialSearchURL} initialPatternType='literal' />
...
<SourcegraphInteractiveSearch initialQuery='list_head and list_add_tail' initialSearchURL={initialSearchURL} initialPatternType='literal' />
...
<SourcegraphInteractiveSearch initialQuery='"ENOENT"' initialSearchURL={initialSearchURL} initialPatternType='literal' />
