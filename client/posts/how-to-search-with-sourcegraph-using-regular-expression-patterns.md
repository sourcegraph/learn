...
<SourcegraphInteractiveSearch initialQuery='#[0-9a-f]{6} lang:css' initialSearchURL={initialSearchURL} initialPatternType='regexp' />
...
<SourcegraphInteractiveSearch initialQuery='(read|write)File' initialSearchURL={initialSearchURL} initialPatternType='regexp' />
...
<SourcegraphInteractiveSearch initialQuery='fs\.(read|write)File' initialSearchURL={initialSearchURL} initialPatternType='regexp' />
...
<SourcegraphInteractiveSearch initialQuery='id\d+ type:symbol' initialSearchURL={initialSearchURL} initialPatternType='regexp' />
...
<SourcegraphInteractiveSearch initialQuery='auth service' initialSearchURL={initialSearchURL} initialPatternType='regexp' />
...
<SourcegraphInteractiveSearch initialQuery='\bcount\b' initialSearchURL={initialSearchURL} initialPatternType='regexp' />
...
<SourcegraphInteractiveSearch initialQuery='(read|write)File\b' initialSearchURL={initialSearchURL} initialPatternType='regexp' />
...
<SourcegraphInteractiveSearch initialQuery='^let' initialSearchURL={initialSearchURL} initialPatternType='regexp' />
...
<SourcegraphInteractiveSearch initialQuery='^\s*let' initialSearchURL={initialSearchURL} initialPatternType='regexp' />
