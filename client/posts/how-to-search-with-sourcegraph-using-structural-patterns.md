...
<SourcegraphInteractiveSearch initialQuery='fprintf(stderr, ...) lang:c repo:^github\.com/torvalds/linux$' initialSearchURL={initialSearchURL} initialPatternType='structural' />
...
<SourcegraphInteractiveSearch initialQuery='fprintf(stderr, ..., err) lang:c repo:^github\.com/torvalds/linux$' initialSearchURL={initialSearchURL} initialPatternType='structural' />
...
<SourcegraphInteractiveSearch initialQuery='fprintf(..., "%s", ...) lang:c repo:^github\.com/torvalds/linux$' initialSearchURL={initialSearchURL} initialPatternType='structural' />
...
<SourcegraphInteractiveSearch initialQuery='fprintf(..., "ERROR: ...", ...) lang:c repo:^github\.com/torvalds/linux$' initialSearchURL={initialSearchURL} initialPatternType='structural' />
...
<SourcegraphInteractiveSearch initialQuery='if (!parts.length && ...) { ... } lang:javascript repo:^github\.com/google/.* count:all' initialSearchURL={initialSearchURL} initialPatternType='structural' />
...
<SourcegraphInteractiveSearch initialQuery='try {...} catch (...) { } finally {...} lang:java repo:^github\.com/elastic/elasticsearch$' initialSearchURL={initialSearchURL} initialPatternType='structural' />
