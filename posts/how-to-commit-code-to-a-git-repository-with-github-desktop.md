...
![The Current Repository tab showing the name of the current repository]()
...
![The Current Repository panel showing a list of repositories]
...
![The Add Local Repository dialog box lets you choose a local repository.]()
...
The **Current Branch** tag displaying the `main` branch 
...
![The **Current Branch** panel in GitHub Desktop]()
...
![The Changes tab showing the list of changed files.]()
...
![Selecting files using the checkboxes in the file list.]()
...
![Entering a commit message into the **Summary** field.]()
...
![The newly created commit displayed below the **Commit** button.]()
...
![The log of commits in the history view, showing the last commit.]()
